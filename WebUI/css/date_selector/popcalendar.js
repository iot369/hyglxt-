...
//  email :	sai_freelance@yahoo.com
	...
	var imgDir = "/css/date_selector/"	// directory for images ... e.g. var imgDir="/img/"
    ...
    */
	...
	{
		var url="/css/date_selector/clock.aspx?fieldname="+fieldname; 
		var mwidth = "280";
		var mheight = "120";
		var loc_x,loc_y;  
		if(window.navigator.appName.toLowerCase().indexOf("netscape") > -1)
	...
	{
		var url="/css/date_selector/clock2.aspx?fieldname="+fieldname; 
		var mwidth = "280";
		var mheight = "120";
		var loc_x,loc_y;  
		if(window.navigator.appName.toLowerCase().indexOf("netscape") > -1)
