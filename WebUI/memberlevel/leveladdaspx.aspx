<%@ Page Language="C#" AutoEventWireup="true" CodeFile="leveladdaspx.aspx.cs" Inherits="leveladdaspx" %>
...
//    }
    ...
    <script type="text/javascript">   
     ...
     var lnum= document.getElementById("txtlnum").value;
       var url="mnum="+mnum+"&mname="+mname+"&mmobile="+mmobile+"&lnum="+lnum+""; 
...
//            url=encodeURI(encodeURI(url));
//            
//            gg.seturl('Ajaxmemberlist.aspx?'+url+'');
            gg.loadData();
        }
...
<body>
    ...
    <div class="divall">
        <div id="layout1">
            ...
            <div class="tools_box">
                <div class="tools_bar">
                    <a onclick="f_opens('405','660','membersAdd.aspx','登记会员','addss');" class="tools_btn">
                        <span><b class="adds">添加</b></span></a> <a onclick="viewmen();" class="tools_btn"><span>
                            <b class="all">查看</b></span></a> <a onclick="deletemem();" class="tools_btn"><span><b
            ...
            <div position="center" title="登记信息" style="padding: 2px;">
