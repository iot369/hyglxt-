        ...
        {   
            if($("#txtoldpass").val()!="")
            {
                ...
                var pwd = $("#txtoldpass").val();
                 $.ajax({
                    url: "Ajaxcheckpwd.aspx?mnum=" + mnum + "&pwd=" + pwd + "",
                    type: "get",
                    cache: false,
...
<body>
    ...
    <div class="divall">
        <table class="addedit">
         <tr>
                <th>
                    原密码：<input id="txtnum" type="text" style="display:none;" runat="server" />
                </th>
                <td>
                    <input id="txtoldpass" type="password" class="txtInput2" style="width: 110px;" runat="server" /><span
                        class="spanxing">*</span>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input id="txtPassword" type="password" class="txtInput2" style="width: 110px;" runat="server" /><span
                        class="spanxing">*</span>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input id="txtPasswords" type="password" class="txtInput2" style="width: 110px;"
