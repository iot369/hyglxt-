<%@ Page Language="C#" AutoEventWireup="true" CodeFile="presentadd.aspx.cs" Inherits="presentadd" %>
...
<head id="Head1" runat="server">
  ...
  function checkmemnum() {
            ...
            var num = $("#txtnum").val();
            $.ajax({
                url: "Ajaxcheck.aspx?gnum=" + num + "",
                type: "get",
                cache: false,
                success: function(date) {
                    if (date=="false") {
                       f_alert2('warn', '礼品编号已存在，请重新录入！');
                        $("#txtnum").val("");
                        return;
...
<body>
    ...
    <div class="divall">
        <div class="divgirdtop">
            <img src="../images/ico-show-txt.png" />新增礼品
        </div>
        <table class="addedit">
            <tr>
                <th>
                ...
                <td>
                    <input id="txtnum" type="text" class="txtInput2" style="width: 100px;" 
                        runat="server" onchange="checkmemnum();" /><span class="spanxing">*</span>
                </td>
                <th>
                    名称：
                </th>
            ...
            <tr>
                ...
                <td>
                    <input id="txtjifen" type="text" class="txtInput2" style="width: 100px;" onchange=" checkuser();"
            ...
            <tr>
                ...
                <td colspan="3">
                    <img style="border: 1px solid #C0C0C0; padding: 3px; width: 100px; height:100px; margin:2px;" id="tmp"  onerror="this.src='../images/noimg.gif '" src="../images/noimg.gif" />
                </td>
            </tr>
        </table>
