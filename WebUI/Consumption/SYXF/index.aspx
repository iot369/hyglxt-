           ...
           var cGetRow=-99999;
            ...
            function add1(Id,Name,Price,cNum)
            {
               ...
               Sarry=txtId[x].value.split('&');
                ...
                newTd6.innerHTML="<input class=\"detail\"  Id=\"txtremark"+i+"\"  name=\"txtremark\" type=\"text\" style=\"width:95%;\" /> " ;
                newTd7.innerHTML='<img src="../../images/check_error.gif" onclick=\"GetRow()\"/>';

                newTd0.style.cssText="text-align: center;border-right-style: solid;border-right-width: 1px;border-right-color: #CCCCCC;border-top-style: solid;border-top-width: 1px;border-top-color: #CCCCCC;width:150px;";
                newTd1.style.cssText="text-align: center;border-right-style: solid;border-right-width: 1px;border-right-color: #CCCCCC;border-top-style: solid;border-top-width: 1px;border-top-color: #CCCCCC;width:80px;";
                newTd2.style.cssText="text-align: center;border-right-style: solid;border-right-width: 1px;border-right-color: #CCCCCC;border-top-style: solid;border-top-width: 1px;border-top-color: #CCCCCC;width:80px;";
                newTd3.style.cssText="text-align: center;border-right-style: solid;border-right-width: 1px;border-right-color: #CCCCCC;border-top-style: solid;border-top-width: 1px;border-top-color: #CCCCCC;width:80px;";
                newTd4.style.cssText="text-align: center;border-right-style: solid;border-right-width: 1px;border-right-color: #CCCCCC;border-top-style: solid;border-top-width: 1px;border-top-color: #CCCCCC;width:120px;";
                newTd5.style.cssText="text-align: center;border-right-style: solid;border-right-width: 1px;border-right-color: #CCCCCC;border-top-style: solid;border-top-width: 1px;border-top-color: #CCCCCC;width:100px;";
                newTd6.style.cssText="text-align: center;border-right-style: solid;border-right-width: 1px;border-right-color: #CCCCCC;border-top-style: solid;border-top-width: 1px;border-top-color: #CCCCCC;width:100px;";
                newTd7.style.cssText="text-align: center;border-right-style: solid;border-right-width: 1px;border-right-color: #CCCCCC;border-top-style: solid;border-top-width: 1px;border-top-color: #CCCCCC;width:80px;";  
        ...
        //消费明细
         function aabb() {
            ...
            for (i = 0; i < str1.length; i++) {
                if(str1[i].value!="")
                {
                strj += str1[i].value + "," + str2[i].value  +"," + str3[i].value+"," + str4[i].value+"," + str5[i].value+"," + str6[i].value+ "," + str7[i].value+ "|";
                }
...
//            }
           ...
           else if($("#CardType").val()=="")
            {
               ...
               $('#txtpassword').attr('disabled','disabled');
                $('#txtchuz').attr('disabled','disabled');
                $('#ckother').attr('disabled','disabled');
            }
            else
            {
            ...
            $('#jiezhan').val('1');
            $.ligerDialog.open({ target: $("#checkDiv"),width:410,height:460,isHidden:true,allowClose:  false });
        }
...
//               }
            ...
            $.ajax({
                    ...
                    success: function(date) {
                       ...
                       else
                       {
                           ...
                           {
                                     var url="liushui="+date+"&CardId=" + $("#CardId").val() + "&yingshou=" + $("#PayMoney").val() + "&shishou=" + shishou + "&yingzhao=" + $('#changes').html() + "&jifen=" + $('#SJiFen').html() + "&SCount=" + $('#SCount').html() + "&detail=" + aa() + "&chuzi="+$("#txtchuz").val()+"";
    ...
    function paynian(idd)
    {
     ...
     function keyLogin(){ 
        ...
        {
            if($('#Button6').attr("disabled")==false)
            {
...
<body onkeydown="keyLogin();">
    ...
    <input id="jiezhan" type="hidden" value="0" />
    <div class="divall">
        <div id="layout1">
            ...
            <div position="center" title="消费项目列表" style="padding: 2px;">
                ...
                <div style="width: 100%; height: 200px; overflow-y: scroll; border-bottom-style: solid;
                    ...
                    <table id="newTB" style="width: 97%; border-top-style: solid; border-bottom-style: solid;
                        ...
                        <tr>
                            ...
                            <th style="width: 120px" class="msttop">
                                折后金额
                            </th>
                ...
                <div class="divgirdbottom" style="text-align: left;">
                    &nbsp;&nbsp; 合计：[<span style="color: Red;">总数量</span><span id="SCount" style="color: Red;">0</span>][<span
                ...
                <div style="width: 100%; height: 30px; line-height: 30px; text-align: right; padding-right: 15px;">
                    <input id="Button6" type="button" value="结 账" class=" btnInput" onclick="checks();"
                        disabled="disabled" />
                    <input id="Button3" type="button" value="读卡(Z)" class=" btnInput" onclick="loadcard();" />
                    ...
                    <tr style="height: 35px;">
                        ...
                        <td style="width: 130px; font-size: 12px; font-weight: bold; color: Black; line-height: 35px;">
                            <input id="txtchuz" type="text" class="txtInput2" style="width: 100px; height: 30px;
                                ...
                                runat="server" value="0.00" onclick="this.select();" onchange="Sumchange();"
                                onkeyup="checknum(this);" />&nbsp;元
                        </td>
                        <td>
                            <input id="txtpassword" type="password" class="txtInput2" style="width: 130px; display: none;"
                                runat="server" disabled="disabled" value="请输入密码..." />
                        </td>
                    </tr>
                    <tr style="height: 35px;">
                        <td style="font-size: 12px; font-weight: bold; width: 90px; color: Black;">
