<%@ Page Language="C#" AutoEventWireup="true" CodeFile="roleslist.aspx.cs" Inherits="roleslist" %>
...
<body>
    ...
    <div class="divall">
        ...
        <div id="layout1">
            ...
            <div position="left" title="角色权限" id="levellist">
                <%=strc %>
            </div>
            <div position="center" title="权限信息" style="padding: 2px; background-color: White;
