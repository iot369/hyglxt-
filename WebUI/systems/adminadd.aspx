...
<head id="Head1" runat="server">
  ...
  function checkmemnum() {
    ...
    function addmem() {
        if ($("#txtnum").val()!=""&&$("#ddlrole").val()!="NONE"&&$("#txtname").val()!=""&&$("#txtPassword").val()!=""&&$("#txtPasswords").val()!=""&&$("#ddlshop").val()!="NONE") 
        {
...
<body>
    ...
    <div class="divall">
        <div class="divgirdtop">
            <img src="../images/ico-show-txt.png" />新增用户
        </div>
        <table class="addedit">
            <tr>
                <th>
            ...
            <tr>
                ...
                <td>
                    <input id="txtusername" type="text" class="txtInput2" style="width: 100px;" onchange=" checkuser();"
                        runat="server" /><span class="spanxing">*</span>
                </td>
                <th>
                    角色权限：
            ...
            <tr>
                ...
                <td>
                    <input id="txtPassword" type="password" class="txtInput2" style="width: 100px;" runat="server" /><span
                        class="spanxing">*</span>
                </td>
                <th>
                    重复密码：
                ...
                <td>
                    <input id="txtPasswords" type="password" class="txtInput2" style="width: 100px;"
