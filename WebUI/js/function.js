...
//===========================单击table改变行颜色 开始================================
 function SettableBGC(tableId) {
            var style;
            var obj = document.getElementById(tableId).getElementsByTagName("tr");//table id
            for (var i = 0; i < obj.length; i++) {
                obj[i].onclick = function() {
                    ...
                    this.style.background = this.style.background == "#4CA5D6" ? "" : "#4CA5D6"; //调整将当前行样式 
                    this.style.color = this.style.color == "#ffffff" ? "#000000" : "#ffffff"; //调整将当前行样式 
                }
            }
        }
//===========================单击table改变行颜色 结束================================
