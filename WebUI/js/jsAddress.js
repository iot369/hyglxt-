...
var provinceList = [
{name:'广东', cityList:[
{name:'东莞市', areaList:['全部','东城区','南城区','莞城区','大朗镇','寮步镇','石排镇','厚街镇','长安镇','塘厦镇','清溪镇','谢岗镇','桥头镇','横沥镇','茶山镇','石碣镇','中堂镇','石碣镇','道滘镇','麻涌镇','万江镇','沙田镇','虎门镇','大岭山镇','黄江镇','凤岗镇','樟木头镇','常平镇','企石镇','东坑镇','石龙镇','高埗镇','望牛墩镇','洪梅镇']},		   		   
