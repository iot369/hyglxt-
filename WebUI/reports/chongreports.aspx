<%@ Page Language="C#" AutoEventWireup="true" CodeFile="chongreports.aspx.cs" Inherits="chongreports" %>
    ...
    <div class="divall">
        <div class="tools_box">
            <div class="tools_bar">
                ...
                <input id="txturl" type="text" style="display: none;" runat="server" value="chongzhou.aspx" />
        ...
        <div id="layout1">
            ...
            <div position="center" title="图形报表" style="padding: 2px;">
                <iframe id="iframetu" frameborder="0" src="chongzhou.aspx?str=Math.random()" width="100%"
                    height="300px;"></iframe>
            </div>
        </div>
        <div id="listview">
