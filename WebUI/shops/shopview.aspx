<%@ Page Language="C#" AutoEventWireup="true" CodeFile="shopview.aspx.cs" Inherits="shopview" %>
                ...
                <div style="padding: 2px; width: 99.5%">
                    <table class="addedit">
                        <tr>
                            ...
                            <td>
                                <input id="txtname" type="text" class="txtInput2" style="width: 130px;" disabled="disabled"
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                ...
                                <script type="text/javascript">
	                                addressInit('cmbProvince', 'cmbCity', 'cmbArea', '<%=dt.Rows[0]["sProvince"].ToString() %>', '<%=dt.Rows[0]["sCity"].ToString() %>', '<%=dt.Rows[0]["sTown"].ToString() %>');
                                </script>
