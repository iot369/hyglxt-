<%@ Page Language="C#" AutoEventWireup="true" CodeFile="consumelist.aspx.cs" Inherits="consumelist" %>
    ...
    <div class="divall">
        <div id="layout1">
            ...
            <div position="center" title="消费项目" style="padding: 2px;">
                <div class="tools_box">
                    <div class="tools_bar">
                        <a onclick="f_opens('300','600','consumeadd.aspx','新增消费项目','addss');" class="tools_btn">
