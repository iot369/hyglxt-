<%@ Page Language="C#" AutoEventWireup="true" CodeFile="consumeadd.aspx.cs" Inherits="consumeadd" %>
...
<head id="Head1" runat="server">
  ...
  function checkmemnum() {
        ...
        if (!reg.test(obj.value)) {
            f_alert2('warn', '消费项目编码格式不正确,请重新输入！');
            $("#txtnum").val("");

        } else {
            var num = $("#txtnum").val();
            $.ajax({
                url: "Ajaxchecknum.aspx?cnum=" + num + "",
                type: "get",
                cache: false,
                success: function(date) {
                    if (date == "false") {

                       f_alert2('warn', '消费项目编码已存在，请重新录入！');
                        $("#txtnum").val("");
                        return;
...
<body>
    ...
    <div class="divall">
        <div class="divgirdtop">
            <img src="../images/ico-show-txt.png" />新增消费项目
        </div>
        <table class="addedit">
            <tr>
                <th>
                ...
                <td>
                    <input id="txtnum" type="text" class="txtInput2" style="width: 100px;" onchange="checkmemnum();"
                ...
                <td>
                    <input id="txtname" type="text" class="txtInput2" style="width: 100px;" runat="server" />
                </td>
            </tr>
            <tr>
                <th>
                ...
                <td>
                    <input id="txtprice" type="text" class="txtInput2" style="width: 100px;" runat="server" />
                </td>
                <th>
                    所属类别：
                </th>
        ...
        <table style="display: none;">
            <tr>
                ...
                <td>
                    <input id="txtBargain" type="text" class="txtInput2" style="width: 100px;" value="0"
                        runat="server" />
                </td>
            </tr>
            <tr>
