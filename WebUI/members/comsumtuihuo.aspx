<%@ Page Language="C#" AutoEventWireup="true" CodeFile="comsumtuihuo.aspx.cs" Inherits="comsumtuihuo" %>
...
<head id="Head1" runat="server">
    ...
    grid=$("#mainxiao").ligerGrid({
        ...
        url: "Ajaxtuihuo.aspx?tables=consumptiondetail&orders=dId&mnum="+mnum+"",
        dataAction: 'server',
        pageSize: 10,
